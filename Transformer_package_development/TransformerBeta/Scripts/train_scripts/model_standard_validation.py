...
decoder_base = TransformerDecoder(
	...
	norm_shape, ffn_num_input, ffn_num_hiddens, num_heads,
	num_layers, dropout)
model_standard = EncoderDecoder(encoder_base, decoder_base)
