...
model_name = 'AF2_transformer_l12h768_validation_anti_l7_1Msteps'
...
resume = True # <------------------------------------------------------------------------change
current_step = 0
training_steps = 600000 # alter the training_steps to the number of steps you want to train # <------------------------------------------------------------------------change
resume_path = 'AF2_transformer_l12h768_validation_anti_l7_1Msteps/AF2_transformer_l12h768_validation_anti_l7_1Msteps_checkpoint_22Dec01_0307AM.pt' # <------------------------------------------------------------------------change
if resume:
