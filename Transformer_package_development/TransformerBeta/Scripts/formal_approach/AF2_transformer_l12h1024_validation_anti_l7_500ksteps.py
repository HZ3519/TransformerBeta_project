...
model_name = 'AF2_transformer_l12h1024_validation_anti_l7_500ksteps'
if not os.path.exists(model_name):
	os.makedirs(model_name)

query_size, key_size, value_size, num_hiddens = 1024, 1024, 1024, 1024
num_layers, dropout = 12, 0.1
lr, training_steps, batch_size, label_smoothing = 0.0002, 500000, 4096, 0.1
...
resume = False # <------------------------------------------------------------------------change
current_step = 0
training_steps = 50000 # alter the training_steps to the number of steps you want to train # <------------------------------------------------------------------------change
