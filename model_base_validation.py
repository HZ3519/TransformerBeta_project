...
dec_comple_peptide_pred, dec_prob, dec_attention_weight_seq = predict_seq2seq(model_base, unseen_target[2], amino_dict, num_steps_prediction, device, save_attention_weights=True, print_info=True)
