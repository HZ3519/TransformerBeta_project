...
dec_comple_peptide_pred, dec_prob, dec_attention_weight_seq = predict_greedy_single(model_base, 'ITLESGEF', amino_dict, num_steps_prediction, device, save_attention_weights=True, print_info=True)
...
peptide_pred = predict_greedy_batch(model_base, X_validation_letter[:50], amino_dict, num_steps_prediction, device)
print(peptide_pred)
...
peptide_candidates = sample_candidates(model_base, 'ITLESGEF', num_candidates, amino_dict, num_steps_prediction, device, max_iter=max_iter)
peptide_candidates
