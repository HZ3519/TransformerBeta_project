...
condition3 = np.nonzero(np.array([len(sequence)>=7 for sequence in X_train_letter]))
...
lr, num_epochs, batch_size, label_smoothing = 0.0004, 2000, 6000, 0.1
