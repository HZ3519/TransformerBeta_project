...
# reverse screen
# please specify:
window_size_list = [4, 5, 6, 7] # fragments length for reversing screening in training 
length = 3  # fragment length above to use for training 
...
lr, training_steps, batch_size, label_smoothing = 0.0004, 200000, 6000, 0.1
...
train_seq2seq_training_steps(model_wide, X_train, X_valid_len, Y_train, Y_valid_len, working_score_tensor, lr, training_steps, batch_size, label_smoothing, amino_dict, device, model_name='model_wide_validation_screen_4', warmup=35000, X_validation=X_validation, Y_validation=Y_validation, X_validation_valid_len=X_validation_valid_len, Y_validation_valid_len=Y_validation_valid_len)