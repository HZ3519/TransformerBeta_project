...
print("number of length 8 samples: ", BSn_data_dataset2_indices_length_7.shape)
print("number of unique length 8 sample: ", BSn_data_dataset2_indices_length_7_unique.shape)
...
for target, label in zip(target_array, label_array):
	...
	if array_index_list[counter%num_resources] in array_index:
		...
		# save to csv file
		np.savetxt('peptides_generation_missing_data/{}_{}.csv'.format(target, label), final_array, delimiter=',', fmt='%s')
